    ...
    <body>
        <div style="width:700px; margin:auto; font-family:arial; font-size:15px; color:#333333; line-height:18px;">
			...
			<div style="margin:auto; padding:15px; border:1px solid #761b31; border-top:none;"><br>
				<p style="font-family:arial; font-size:15px; color:#761b31; line-height:18px; margin:0px;"><b>Best Regards,</b><br>
				<a href="javascript:void(0);" style="color:#761b31; text-decoration:none;" >Team <?php echo "WedSetGo"; ?></a>.</p><br>
			</div>
